...
array = string_array.split.each_slice(20).to_a.collect! do |ary|
...
array.each_with_index do |n, i|
  n.each_with_index do |m, j|
    begin
      ...
      products << left_down_product = array[i][j] * array[i+1][j-1] * array[i+2][j-2] * array[i+3][j-3]
